When (/^I open all deal section$/) do
  Element.click(:xpath, '//*[@text="//android.widget.Button[@content-desc="See All Deals"]')
end
...
unless name.text == expected_name[counter]
  error_list << "Wrong tab name, expected: #{expected_names}, got: #{name.text}"
end
counter=+1
end
